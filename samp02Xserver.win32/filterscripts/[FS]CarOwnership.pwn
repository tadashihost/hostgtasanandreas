...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd,"/car",true)==0)
	{
	    ...
	    if(!strlen(tmp))
	    {
	        ...
	        SendClientMessage(playerid,COLOR_WHITE,"(( Car Ownership By Ringo Jones ))");
	        SendClientMessage(playerid,COLOR_WHITE,"(( This Car Ownership Script Is still under construction so it isnt perfect ))");
	        return 1;
	    }
