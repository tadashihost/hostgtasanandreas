...
stock ReadObjects() {
    ...
    if (!(fexist("BREAD_LOL.TXT.TXT"))) {
        PrintError("'scriptfiles/BREAD_LOL.TXT' not found; skipping objects", 1);
        return 0;
    }
    
    hFile = fopen("BREAD_LOL.TXT", io_read);
...
stock SaveObjects() {
    ...
    hFile = fopen("BREAD_LOL.TXT", io_write);
